...
<template>
  <header class="bg-primary text-primary-content border-b-2 border-dashed border-secondary">
    <div class="mx-auto flex h-12 max-w-5xl items-center px-2">
      <div class="flex items-center">
        <RouterLink
          to="/topics"
          class="label-mono flex h-12 items-center px-3 no-underline tracking-wider text-primary-content/90 hover:text-primary-content"
        >
          HANALAND
        </RouterLink>
        <div class="mx-2 h-5 w-px bg-primary-content/20" />
        <RouterLink
          to="/topics"
          class="label-mono flex h-12 items-center px-2 no-underline text-primary-content/60 hover:text-primary-content"
        >
          TOPICS
        </RouterLink>
        <RouterLink
      ...
      <div class="ml-auto flex items-center">
        <RouterLink
          to="/notifications"
          class="relative flex h-12 items-center px-3 text-primary-content/60 hover:text-primary-content"
        >
        ...
        <div class="mx-1 h-5 w-px bg-primary-content/20" />
