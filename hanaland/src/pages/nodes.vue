            ...
            <div v-for="[section, sectionNodes] in groupedNodes" :key="section">
              ...
              <div class="flex flex-wrap gap-2">
                <RouterLink
                  ...
                  class="label-mono inline-flex items-center gap-1 border border-dashed border-secondary/50 px-3 py-1.5 text-xs text-base-300 no-underline hover:border-secondary hover:text-primary"
                >
                  {{ node.name }}
          ...
          <div v-else class="space-y-3">
            ...
            >
              ...
              <div class="min-w-0 flex-1">
                <div class="truncate text-sm font-medium text-base-content hover:text-primary">{{ u.name }}</div>
