        ...
        <form @submit.prevent="submit">
          <div class="mb-4">
            <input
              ...
              type="text"
              placeholder="TITLE"
              class="w-full border-neutral bg-base-100 px-3 py-2 font-mono text-sm text-base-content placeholder-base-300 outline-none focus:border-accent"
              required
            />
          </div>
          ...
          <div class="mb-4">
            <select
              v-model="nodeId"
              class="w-full border-neutral bg-base-100 px-3 py-2 font-mono text-sm text-base-content outline-none focus:border-accent"
              required
            >
          ...
          <div class="mb-4">
            <textarea
              v-model="body"
              class="h-64 w-full border-neutral bg-base-100 px-3 py-2 font-mono text-sm text-base-content placeholder-base-300 outline-none focus:border-accent"
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              ...
              <RouterLink to="/topics" class="label-mono text-xs text-base-300 hover:text-neutral">取消</RouterLink>
              <button
                type="submit"
